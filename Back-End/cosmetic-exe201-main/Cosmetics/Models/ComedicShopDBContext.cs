...
public partial class ComedicShopDBContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.SessionId).HasName("PK__ChatSess__C9F49270");
        ...
        {
            entity.HasKey(e => e.MessageId).HasName("PK__ChatMess__C87C037C");

            entity.Property(e => e.MessageId).HasDefaultValueSql("(newid())");
            entity.Property(e => e.Content).HasColumnType("nvarchar(max)").IsRequired();
            entity.Property(e => e.ProductRecommendations).HasColumnType("nvarchar(max)");
